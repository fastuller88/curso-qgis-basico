...
* [6. Módulo: Creando Datos Vectoriales](#6-módulo-creando-datos-vectoriales)
    - [6.1. Lección: Creando un Nuevo Conjunto de Datos Vectoriales](#61-lección-creando-un-nuevo-conjunto-de-datos-vectoriales)
        + [6.1.1. Paso a Paso: Cuadro de Diálogo de Creación de Capas](#611--paso-a-paso-cuadro-de-diálogo-de-creación-de-capas)
        + [6.1.2. Paso a Paso: Fuentes de Datos](#612--paso-a-paso-fuentes-de-datos)
        + [6.1.3. Inténtalo tú!](#)
        + [6.1.4. Inténtalo tú!](#)
        + [6.1.5. En Conclusión](#)
